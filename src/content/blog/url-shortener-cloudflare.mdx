...
<Warning>
  **Note December 12 2025**:
  ...
  Watch out! This code is 3 years old, and some of these APIs may have changed.
  
  Updates:
  - I think pnpm should be the default for new projects over yarn or npm
  - I would probably use a [HTML tagged literal](https://www.npmjs.com/package/html-template-tag) to give the HTML in this blog syntax highlighting and technically prevent HTML injection
</Warning>
